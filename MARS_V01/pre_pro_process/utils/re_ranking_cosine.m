function [ final_dist ] = re_ranking_cosine( feat, M, W, query_num, k1, k2, lambda)
% k-reciprocal re-ranking

% Changes by Xinshao Wang:
% 1. Using consine distance
% 2. The input is normalized features with dimension (D, Np+Ng)

%% initial ranking list
%original_dist = MahDist(M, feat' * W, feat' * W);

% The feat is already normalized for input 
original_dist = feat' * feat;
