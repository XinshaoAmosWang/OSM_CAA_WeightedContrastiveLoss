function [tracklet_feature] = process_tracklet_prob_local3(net, tracklet, batch_size)
%PROCESS_TRACKLET_PROB_LOCAL3 Summary of this function goes here
...
feature2 = bsxfun(@times, feature2, score(:,1));
feature3 = bsxfun(@times, feature3, score(:,1));
tracklet_feature = [sum( feature1 / sum(score(:,1)) ),...
                    sum( feature2 / sum(score(:,1)) ),...
                    sum( feature3 / sum(score(:,1)) )];
