...
param.traindata_filename = 'train_data_LPW1';
param.save_model_file = 'LPW';
param.save_model_name = 'LPW_iter';
param.test_start = 50000;
param.test_interval = 5000;
param.train_maxiter = 65000;
...
split_index = 1;
    ...
    load(fullfile(param.data_path, param.traindata_filename, 'train_data_tracklet_format.mat'));
    ...
    while iter < param.train_maxiter
        ...
        [batch_data, batch_label] = get_train_minibatch_LPW_V006_even_tracklet(tracklet_num, frame_per_tracklet, ...
