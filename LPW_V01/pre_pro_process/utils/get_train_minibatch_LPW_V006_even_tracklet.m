function [batch_data, batch_label] = get_train_minibatch_LPW_V006_even_tracklet (tracklet_num, frame_per_tracklet, ...
    ...
    for i = 1 : tracklet_num
        ...
        for fr = 1 : frame_per_tracklet
            batch_label(:,:,:, (i-1)*frame_per_tracklet + fr ) = select_id - 1;
