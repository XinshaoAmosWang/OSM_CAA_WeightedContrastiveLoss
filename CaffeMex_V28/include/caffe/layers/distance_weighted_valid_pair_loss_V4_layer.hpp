#ifndef CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V4_LAYER_HPP_
#define CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V4_LAYER_HPP_
...
class DistanceWeightedValidPairLossV4Layer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit DistanceWeightedValidPairLossV4Layer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "DistanceWeightedValidPairLossV4"; }
...
#endif  // CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V4_LAYER_HPP_