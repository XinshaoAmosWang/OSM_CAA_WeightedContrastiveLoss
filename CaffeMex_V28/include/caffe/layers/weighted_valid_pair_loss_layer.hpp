#ifndef CAFFE_WEIGHTED_VALID_PAIR_LOSS_LAYER_HPP_
#define CAFFE_WEIGHTED_VALID_PAIR_LOSS_LAYER_HPP_
...
class WeightedValidPairLossLayer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit WeightedValidPairLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "WeightedValidPairLoss"; }
...
#endif  // CAFFE_WEIGHTED_VALID_PAIR_LOSS_LAYER_HPP_