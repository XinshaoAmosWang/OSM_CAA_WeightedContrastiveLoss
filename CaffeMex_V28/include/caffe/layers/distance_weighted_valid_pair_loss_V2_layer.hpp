#ifndef CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V2_LAYER_HPP_
#define CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V2_LAYER_HPP_
...
class DistanceWeightedValidPairLossV2Layer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit DistanceWeightedValidPairLossV2Layer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "DistanceWeightedValidPairLossV2"; }
...
#endif  // CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V2_LAYER_HPP_