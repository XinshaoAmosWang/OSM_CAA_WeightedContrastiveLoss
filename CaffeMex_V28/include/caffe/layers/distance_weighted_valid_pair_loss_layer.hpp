#ifndef CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_LAYER_HPP_
#define CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_LAYER_HPP_
...
class DistanceWeightedValidPairLossLayer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit DistanceWeightedValidPairLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "DistanceWeightedValidPairLoss"; }
...
#endif  // CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_LAYER_HPP_