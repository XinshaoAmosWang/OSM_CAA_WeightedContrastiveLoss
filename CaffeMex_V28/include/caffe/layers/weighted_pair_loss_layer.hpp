#ifndef CAFFE_WEIGHTED_PAIR_LOSS_LAYER_HPP_
#define CAFFE_WEIGHTED_PAIR_LOSS_LAYER_HPP_
...
class WeightedPairLossLayer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit WeightedPairLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "WeightedPairLoss"; }
...
#endif  // CAFFE_WEIGHTED_PAIR_LOSS_LAYER_HPP_