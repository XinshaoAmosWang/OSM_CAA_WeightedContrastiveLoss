#ifndef CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V3_LAYER_HPP_
#define CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V3_LAYER_HPP_
...
class DistanceWeightedValidPairLossV3Layer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit DistanceWeightedValidPairLossV3Layer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "DistanceWeightedValidPairLossV3"; }
...
#endif  // CAFFE_DISTANCE_WEIGHTED_VALID_PAIR_LOSS_V3_LAYER_HPP_